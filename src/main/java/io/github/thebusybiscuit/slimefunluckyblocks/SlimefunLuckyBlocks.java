...
public class SlimefunLuckyBlocks extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        new ItemStack[] { SlimefunItems.GOLD_12K.asOne(), SlimefunItems.GOLD_12K.asOne(), SlimefunItems.GOLD_12K.asOne(), SlimefunItems.GOLD_12K.asOne(), new ItemStack(Material.DISPENSER), SlimefunItems.GOLD_12K.asOne(), SlimefunItems.GOLD_12K.asOne(), SlimefunItems.GOLD_12K.asOne(), SlimefunItems.GOLD_12K.asOne() }).register(this, surprises, s -> s.getLuckLevel() != LuckLevel.PANDORA);

        new LuckyBlock(itemGroup, veryLuckyBlock, RecipeType.ENHANCED_CRAFTING_TABLE,
        new ItemStack[] { null, SlimefunItems.GOLD_12K.asOne(), null, SlimefunItems.GOLD_12K.asOne(), luckyBlock.asOne(), SlimefunItems.GOLD_12K.asOne(), null, SlimefunItems.GOLD_12K.asOne(), null }).register(this, surprises, s -> s.getLuckLevel() == LuckLevel.LUCKY);

        new LuckyBlock(itemGroup, veryUnluckyBlock, RecipeType.ENHANCED_CRAFTING_TABLE,
        new ItemStack[] { null, new ItemStack(Material.SPIDER_EYE), null, new ItemStack(Material.SPIDER_EYE), luckyBlock.asOne(), new ItemStack(Material.SPIDER_EYE), null, new ItemStack(Material.SPIDER_EYE), null }).register(this, surprises, s -> s.getLuckLevel() == LuckLevel.UNLUCKY);
